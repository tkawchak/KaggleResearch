...
def build_features(df):
	...
	# categorical data: assign numerical values for each class
	

	# continuous variables: no processing should be required
	# just make sure that these are numerical
...
print(y)
import sys
sys.exit('quitting to explore the dataset\n')
